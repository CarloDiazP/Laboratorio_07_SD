...
public class SOAPIProxy implements org.example.soap.SOAPI {
  private String _endpoint = null;
  private org.example.soap.SOAPI sOAPI = null;
  ...
  private void _initSOAPIProxy() {
    try {
      sOAPI = (new org.example.soap.SOAPImplServiceLocator()).getSOAPImplPort();
      if (sOAPI != null) {
        if (_endpoint != null)
  ...
  public org.example.soap.SOAPI getSOAPI() {
    if (sOAPI == null)
      _initSOAPIProxy();
    return sOAPI;
  }
