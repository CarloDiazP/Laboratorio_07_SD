...
public class SOAPImplServiceLocator extends org.apache.axis.client.Service implements org.example.soap.SOAPImplService {
    ...
    public org.example.soap.SOAPI getSOAPImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public org.example.soap.SOAPI getSOAPImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.example.soap.SOAPImplPortBindingStub _stub = new org.example.soap.SOAPImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.example.soap.SOAPI.class.isAssignableFrom(serviceEndpointInterface)) {
                org.example.soap.SOAPImplPortBindingStub _stub = new org.example.soap.SOAPImplPortBindingStub(new java.net.URL(SOAPImplPort_address), this);
                _stub.setPortName(getSOAPImplPortWSDDServiceName());
                return (Remote) _stub;
            }
        }
